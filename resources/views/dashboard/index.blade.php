...
<div class="row g-3">
    ...
    <div class="col-md-4"><div class="card p-3"><div>المبلغ الصافي</div><div class="stat-number">{{ number_format($netAmount, 2) }}</div><div class="text-muted small">(إجمالي المبالغ المخصومة) - النظافة</div></div></div>
</div>
