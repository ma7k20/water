...
<div class="row g-3">
    ...
    <div class="col-md-3">
        ...
        <input type="text" step="0.01" min="0" name="unit_price" class="form-control" value="{{ old('unit_price', $customer->unit_price ?? '') }}" required>
    </div>

    <div class="col-md-3">
        <label class="form-label">القراءة السابقة</label>
        <input type="text" step="0.01" min="0" name="previous_reading" class="form-control" value="{{ old('previous_reading', $customer->previous_reading ?? 0) }}" required>
    </div>
    ...
    <div class="col-md-3">
        ...
        <input type="text" step="0.01" name="previous_balance" class="form-control" value="{{ old('previous_balance', $customer->previous_balance ?? 0) }}" required>
    </div>
